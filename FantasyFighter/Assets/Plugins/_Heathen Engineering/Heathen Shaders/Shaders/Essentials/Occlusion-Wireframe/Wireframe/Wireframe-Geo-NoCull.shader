...
Shader "Heathen/Essentials/Occlusion-Wireframe/Wireframe/Geometry No Cull (DX11 only)"
{
	Properties 
	{
		_EdgeColor("WireColor", Color) = (1,0,0,1)
    	...
    	Pass 
    	{
			...
			half4 frag(g2f IN) : COLOR
			{
				...
				//fade based on dist from center
 				...
 				//return lerp(_FaceColor, _EdgeColor, I);				
			}
